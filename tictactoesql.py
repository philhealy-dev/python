...
connection = mysql.connector.connect(host='phildb2.cbfsq5fwzuf8.us-east-1.rds.amazonaws.com',
                                         database='tictactoe',
                                         user='admin',
                                         password='hardening1')


sql_select_Query = "select * from player"
cursor = connection.cursor()
cursor.execute(sql_select_Query)
# get all records. Used to pull player name from mysql for welcome message
records = cursor.fetchall()

from IPython.display import clear_output  # prints the display board clearly 
